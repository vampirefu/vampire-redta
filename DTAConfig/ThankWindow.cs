...
namespace DTAClient.DXGUI.Generic
{
    public class ThankWindow : XNAWindow
    {
        ...
        public override void Initialize()
        {
            ...
            //lblThankList.AddItem("流问天（背景音乐及模式制作)");
            //lblThankList.AddItem("流问天（中文语音包)");
            //lblThankList.AddItem("流问天（防守地图)");
            //lblThankList.AddItem("阿来XL（提供单位数值调整建议）");
            //lblThankList.AddItem("青云小子（游戏思路构化）");
            //lblThankList.AddItem("君悦OwO、软果儿（单位代码调整及优化）");
            //lblThankList.AddItem("此外，也感谢咕咚、方外之火从去年一直和阿来帮着运营共辉群以及积极测试。感谢“南柯一梦天醉欢”、“舍，才有得”、“饼干”、“枫CXL岚”、“KIRK”等玩家对新共辉的鼎力相助。");
